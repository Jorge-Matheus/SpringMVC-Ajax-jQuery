...
public class AgendamentoController {
	...
	// abre a página de agendamento de consultas
	...
	public String salvar(Agendamento agendamento, RedirectAttributes attr, @AuthenticationPrincipal User user) {
		Paciente paciente = pacienteService.BuscarPoUsuarioEmail(user.getUsername());
	...
	// abrir página de historico de agendamento do paciente
	@PreAuthorize("hasAnyAuthority('PACIENTE', 'MEDICO')")
